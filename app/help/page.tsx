  ...
  return (
    <div className="fixed inset-0 w-full h-full flex flex-col bg-black text-foreground">
      ...
      <main className="flex-1 overflow-auto">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold text-[#F0A741] mb-6">pGlobe Help & Documentation</h1>
        ...
        <section className="mb-8">
          ...
          <div className="bg-muted/30 rounded-lg p-4 sm:p-6 space-y-3 sm:space-y-4">
            <p className="text-foreground/80">
              pGlobe is a real-time analytics dashboard for the <strong className="text-[#F0A741]">Xandeum pNode network</strong>. 
          ...
          <div className="space-y-4">
            <div className="bg-muted/30 rounded-lg p-6">
              ...
              <dl className="space-y-3">
                <div>
                  <dt className="text-sm font-medium text-[#3F8277]">Total Nodes</dt>
                  <dd className="text-sm text-foreground/70">Total number of pNodes discovered in the gossip network.</dd>
                </div>
                <div>
                  <dt className="text-sm font-medium text-[#3F8277]">Online / Syncing / Offline</dt>
            ...
            <div className="bg-muted/30 rounded-lg p-6">
              ...
              <dl className="space-y-3">
                <div>
                  <dt className="text-sm font-medium text-[#F0A741]">Avg Uptime (%)</dt>
                  <dd className="text-sm text-foreground/70">
                ...
                <div>
                  <dt className="text-sm font-medium text-[#F0A741]">Avg CPU (%)</dt>
                  <dd className="text-sm text-foreground/70">
                ...
                <div>
                  <dt className="text-sm font-medium text-[#F0A741]">Avg RAM (%)</dt>
                  <dd className="text-sm text-foreground/70">
                ...
                <div>
                  <dt className="text-sm font-medium text-[#F0A741]">Avg Latency (ms)</dt>
                  <dd className="text-sm text-foreground/70">
        ...
        <section className="mb-8">
          ...
          <div className="bg-muted/30 rounded-lg p-6 space-y-4">
            ...
            <div className="flex gap-4 mt-4">
              <span className="text-[#3F8277]">● 80-100: Excellent</span>
              <span className="text-[#F0A741]">● 60-79: Good</span>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-foreground mb-4 flex items-center gap-2">
            <span className="text-[#3F8277]">●</span> Deployment & Usage Documentation
          </h2>
              <div className="bg-gradient-to-br from-muted/40 to-muted/20 rounded-lg p-6 sm:p-8 border border-[#F0A741]/20">
            <div className="space-y-6">
              <p className="text-foreground/90 leading-relaxed">
                The <strong className="text-[#F0A741]">Xandeum pNode Analytics Platform</strong> is a production-ready, 
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-black/20 rounded-lg p-5 border border-[#F0A741]/10">
                  <h4 className="font-semibold text-[#F0A741] mb-3 text-base flex items-center gap-2">
              ...
              <div className="bg-black/30 rounded-lg p-6 mt-6 border-l-4 border-[#3F8277]">
                <h3 className="font-semibold text-foreground mb-4 text-lg flex items-center gap-2">
                  <svg className="w-5 h-5 text-[#3F8277]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-8 pt-6 border-t border-border">
          <Link 
            href="/"
            className="inline-flex items-center gap-2 text-[#F0A741] hover:underline"
          >
            ← Back to Dashboard
          </Link>
        </div>
