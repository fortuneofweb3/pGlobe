  ...
  try {
    ...
    const pipeline: import('mongodb').Document[] = [
      ...
      // Project only the fields we need
      {
        $project: {
          ...
          mainnetCredits: '$nodeSnapshots.mainnetCredits',
          devnetCredits: '$nodeSnapshots.devnetCredits',
          network: '$nodeSnapshots.network',
    ...
    const nodeHistory = results.map((result) => {
      ...
      return {
        ...
        mainnetCredits: res.mainnetCredits as number | undefined,
        devnetCredits: res.devnetCredits as number | undefined,
        network: res.network as string | undefined,
