  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-[#F0A741] hover:bg-[#F0A741]/90 text-black shadow-lg hover:shadow-xl flex items-center justify-center group transition-all duration-500 ease-out ${isOpen
      ...
      {/* Chat Widget */}
      <div
        className={`fixed bottom-6 right-6 z-50 w-[calc(100vw-3rem)] md:w-[460px] max-w-md bg-black/95 backdrop-blur-md border border-[#F0A741]/20 rounded-2xl shadow-2xl flex flex-col overflow-hidden transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] ${isOpen
          ? isMinimized
      ...
      >
        ...
        {!isMinimized && (
          <>
            <div
              className={`flex-1 overflow-y-auto p-4 space-y-4 transition-all duration-500 ${isOpen ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
                }`}
            ...
            {/* Input */}
            <div
              className={`p-4 border-t border-[#F0A741]/20 bg-black/50 rounded-b-2xl transition-all duration-500 ${isOpen ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
                }`}
