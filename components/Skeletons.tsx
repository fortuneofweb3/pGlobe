        ...
        <div className="overflow-x-auto overflow-y-auto flex-1 min-h-0 bg-card">
          <table className="min-w-full border-collapse m-0 border-spacing-0">
            ...
            <tbody className="divide-y divide-white/10">
              {[...Array(rows)].map((_, i) => (
                <tr key={i} className="border-b border-white/10 bg-white/[0.01]">
...
export function StatCardSkeleton() {
  return (
    <div className="card-stat bg-[#0a0a0a] border-white/10 backdrop-blur-md overflow-hidden">
...
export function ManagerCardSkeleton({ count = 8 }: { count?: number }) {
  return (
    <>
      {[...Array(count)].map((_, i) => (
        <div key={i} className="card p-4 flex flex-col h-full bg-[#0a0a0a] border-white/10">
          {/* Top Row: Info + Donut */}
          ...
          <div className="grid grid-cols-3 gap-2 mb-4">
            {[...Array(3)].map((_, j) => (
              <div key={j} className="bg-muted/5 rounded p-2 flex flex-col items-center justify-center gap-1 border border-white/10">
